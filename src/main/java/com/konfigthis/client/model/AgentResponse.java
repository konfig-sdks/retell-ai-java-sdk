...
public class AgentResponse {
 ...
 public enum LanguageEnum {
  ...
  public AgentResponse agentId(String agentId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "oBeDLoLOeuAbiuaMFXRtDOLriTJ5tSxD", required = true, value = "Unique id of agent.")
  ...
  public AgentResponse llmWebsocketUrl(String llmWebsocketUrl) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "wss://your-websocket-endpoint", required = true, value = "The URL we will establish LLM websocket for getting response, usually your server. Check out [LLM WebSocket](https://raw.githubusercontent.com) for more about request format (sent from us) and response format (send to us).")
  ...
  public AgentResponse voiceId(String voiceId) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "11labs-Adrian", required = true, value = "Unique voice id used for the agent. Find list of available voices and their preview in Dashboard.")
  ...
  public AgentResponse voiceTemperature(Double voiceTemperature) {
  ...
  public AgentResponse voiceTemperature(Integer voiceTemperature) {
  ...
  **/
  ...
  public AgentResponse voiceSpeed(Double voiceSpeed) {
  ...
  public AgentResponse voiceSpeed(Integer voiceSpeed) {
  ...
  **/
  ...
  public AgentResponse responsiveness(Double responsiveness) {
  ...
  public AgentResponse responsiveness(Integer responsiveness) {
  ...
  **/
  ...
  public AgentResponse enableBackchannel(Boolean enableBackchannel) {
  ...
  **/
  ...
  public AgentResponse ambientSound(AmbientSoundEnum ambientSound) {
  ...
  **/
  ...
  public AgentResponse language(LanguageEnum language) {
  ...
  **/
  ...
  public AgentResponse webhookUrl(String webhookUrl) {
  ...
  **/
  ...
  public AgentResponse boostedKeywords(List<String> boostedKeywords) {
  ...
  public AgentResponse addBoostedKeywordsItem(String boostedKeywordsItem) {
  ...
  **/
  ...
  public AgentResponse formatText(Boolean formatText) {
  ...
  **/
  ...
  public AgentResponse optOutSensitiveDataStorage(Boolean optOutSensitiveDataStorage) {
  ...
  **/
  ...
  public AgentResponse lastModificationTimestamp(Integer lastModificationTimestamp) {
  ...
  **/
   ...
   * @return the AgentResponse instance itself
   */
  public AgentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.agentId, agentResponse.agentId) &&
        Objects.equals(this.llmWebsocketUrl, agentResponse.llmWebsocketUrl) &&
        Objects.equals(this.voiceId, agentResponse.voiceId) &&
        Objects.equals(this.voiceTemperature, agentResponse.voiceTemperature) &&
        Objects.equals(this.voiceSpeed, agentResponse.voiceSpeed) &&
        Objects.equals(this.responsiveness, agentResponse.responsiveness) &&
        Objects.equals(this.enableBackchannel, agentResponse.enableBackchannel) &&
        Objects.equals(this.ambientSound, agentResponse.ambientSound) &&
        Objects.equals(this.agentName, agentResponse.agentName) &&
        Objects.equals(this.language, agentResponse.language) &&
        Objects.equals(this.webhookUrl, agentResponse.webhookUrl) &&
        Objects.equals(this.boostedKeywords, agentResponse.boostedKeywords) &&
        Objects.equals(this.formatText, agentResponse.formatText) &&
        Objects.equals(this.optOutSensitiveDataStorage, agentResponse.optOutSensitiveDataStorage) &&
        Objects.equals(this.lastModificationTimestamp, agentResponse.lastModificationTimestamp)&&
        Objects.equals(this.additionalProperties, agentResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(agentId, llmWebsocketUrl, voiceId, voiceTemperature, voiceSpeed, responsiveness, enableBackchannel, ambientSound, agentName, language, webhookUrl, boostedKeywords, formatText, optOutSensitiveDataStorage, lastModificationTimestamp, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AgentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AgentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentResponse is not found in the empty JSON string", AgentResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentResponse>() {
           @Override
           public void write(JsonWriter out, AgentResponse value) throws IOException {
           ...
           @Override
           public AgentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AgentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AgentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AgentResponse
  * @throws IOException if the JSON string is invalid with respect to AgentResponse
  */
  public static AgentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentResponse.class);
  }

 /**
  * Convert an instance of AgentResponse to an JSON string
  *
  * @return JSON string
  */
